...
<form action="/do.vacancy?cc=<%=Command.UPDATE_VACANCY.code()%>" method="POST" enctype='multipart/form-data'>
...
<input type = "text" name = "<%=FIELD_NAME.BASIC.value()%>" value = "9999"/>
</div>

<div>
For how long do you want to display the vacancy? 2 weeks cost RS 2800
<input type = "text" name = "<%=FIELD_NAME.START_DATE.value()%>" value="2016-09-09"/>
</div>
<div>
For how long do you want to display the vacancy? 2 weeks cost RS 2800
<input type = "text" name = "<%=FIELD_NAME.END_DATE.value()%>" value="2016-09-10" />
</div>
...
<div>
hidden vacancy code
<input type = "text" name = "<%=FIELD_NAME.VACANCY.value()%>" value = "1"/>
</div>
